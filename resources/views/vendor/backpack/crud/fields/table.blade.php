...
@include('crud::fields.inc.wrapper_start')
    ...
    <div class="array-container form-group">
        ...
        <table class="table table-sm table-striped m-b-0">
            ...
            <tbody class="table-striped items sortableOptions">
                ...
                <tr class="array-row clonable" style="display: none;">
                    ...
                    <td>
                        <input class="form-control" type="text" data-cell-name="item.{{ $column }}">
                    </td>
                    @endforeach
                    <td>
        ...
        <div class="array-controls btn-group m-t-10">
            <button class="btn btn-light" type="button" data-button-type="addItem"><i class="la la-plus"></i> {{trans('backpack::crud.add')}} {{ $item_name }}</button>
        </div>
